  ...
  <section class="container">
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
      ...
      <div class="home-about">
        <h2>Building strong brands and successful websites.</h2>
         <p>I’ve been working as a web designer/developer for over 8 years and enjoy collaborating with creative partners to provide a quality product. Check out my <a href="https://www.design2seo.com/portfolio/">portfolio</a> to see companies of all types and sizes that I have helped build strong brands and websites.</p>
<p>As a WordPress developer I have the ability to develop custom themes as well as work with pre-made themes. I am able to develop custom <code>php</code>, <code>js</code> and <code>css</code> features to create a unique user experience.</p>
<p>I have worked with clients to solve complex problems and my ultimate goal is to make websites more successful and easier to manage.</p>
      </div>
      <div class="spacer-sm"></div>
      </div>
      <div class="spacer-sm"></div>
...
<section class="container-nb blog">
  ...
  <section class="grid-1x1">
   ...
   query_posts( array( 'posts_per_page' => 4, 'order'=> 'DESC', 'category_name' => 'blog', 'post_type' => 'post', 'paged' => $paged ) );
...
<section class="container-nb">
  <nav class="nav-pagination" role="navigation">
    <span class="nav-previous pagenav">
      <?php next_posts_link( __( '<span class="meta-nav"><i class="fa icon-arrow-left"></i></span> Older Posts', 'cafe-faucher' ) ); ?>
    </span>
    <span class="nav-next pagenav">
