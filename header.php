...
<head>
  ...
  <?php } elseif (in_category('wordpress-development-experience')) { ?>
  <?php } elseif (in_category('graphic-design-experience')) { ?>
  <?php } elseif (in_category('ux-ui-experience')) { ?>
  <?php } elseif (in_category('branding-experience')) { ?>
  <?php } else { ?>
